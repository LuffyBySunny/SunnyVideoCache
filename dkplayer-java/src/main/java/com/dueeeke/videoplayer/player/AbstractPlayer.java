...
public abstract class AbstractPlayer {
    ...
    protected PlayerTimeChangeListener mPlayerTimeChangeListener;
    ...
    public void setPlayerTimeChangeListener(PlayerTimeChangeListener playerTimeChangeListener) {
        mPlayerTimeChangeListener = playerTimeChangeListener;
    }

    public interface PlayerTimeChangeListener{
